...
class PNRComponent extends React.Component {
    ...
    render() {
        return (
            ...
            <div className="app">
                <h1>This is Engineer's desk Railway Website</h1>
                <h3>Please enter your PNR Number</h3>
                <div>
                    <div className="inc"><input type="text" id="pnr" name="pnr" value={this.state.PNRNumber} onChange={this.handleChange}  /></div>
                    <div className="inc2"><button type="submit" onClick={this.handleSubmit}> Search</button></div>
                </div>
